...
#define L9 "-0.00	cp	ch	cp	a	hyvee-12/10/13abcdefghijklmnopqrstuvwxyz__hyvee-12/10/13abcdefghijklmnopqrstuvwxyz__hyvee-12/10/13abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__abcdefghijklmnopqrstuvwxyz__\tgagagadada\n-6.76		ch	cp	a	hyvee-1711902571-65.98\n-30.14		ch	cp	a	hyvee-1711902571-65.98\n		ch	cp	a	hyvee-1711902571-65.98\n-15.36		ch	cp	a	hyvee-1711902571-65.98\n-7.31		ch	cp	a	hyvee-1711902571-65.98\n305.26			cp	a	condensed\n112.21			cp	b	condensed\n256.03			cp	c	condensed\n138.33			cp	d	condensed\n90.00			cp	knee	condensed\n2114.56			cp	r	condensed\n3553.04			cps		condensed\n"


int main(){
  int i, j, test, ntests = 10;
  Ledger *ledger;
  char **strs;
