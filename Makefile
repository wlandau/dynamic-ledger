...
DEP+=check_legal_double_modify condense condense_and_print condense_str
...
DEP+=insert_row_str is_space legal_amounts modify
DEP+=modify_str new_ledger print_ledger_to_stream print_ledger_to_string
